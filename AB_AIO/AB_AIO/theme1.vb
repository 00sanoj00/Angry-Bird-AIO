...
Module Draw
    ...
    Public Sub DrawDropShadow(ByVal G As Graphics, ByVal Color As Color, ByVal pth As GraphicsPath, ByVal size As Integer, Optional ByVal Angle As Single = 120, Optional ByVal Distance As Single = 0, Optional ByVal Opacity As Single = 1, Optional ByVal Spread As Single = 2)
        'Credit to BlackCap
        ' Trim the angle
